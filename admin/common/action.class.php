    ...
    */
	public function Get_admin_msg($url, $show = '操作已成功！') {
		...
		<html xmlns="http://www.w3.org/1999/xhtml"><head>
				...
				<div class="wrapper">
					<div class="loginBox">
				  <table width="100%" align="center"  cellpadding="3" cellspacing="0" style="padding:10px;font: 18px;">
				    <tr>
				      <th align="center" style="background:#AEEEEE;text-align:center;" >' . $show . '</th>
				    </tr>
				    <tr>
				      <td><br /><p>2秒后返回指定页面！<br /><br />
